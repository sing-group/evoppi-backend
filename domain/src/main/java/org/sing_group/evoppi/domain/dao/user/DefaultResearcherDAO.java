...
public class DefaultResearcherDAO
extends AbstractUserManagementDAO<Researcher>
implements ResearcherDAO {

  DefaultResearcherDAO() {}

  public DefaultResearcherDAO(EntityManager em) {
    super(em);
  }
