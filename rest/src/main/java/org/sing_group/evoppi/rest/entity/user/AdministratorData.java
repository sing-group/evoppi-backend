 ...
 */
@XmlRootElement(name = "admin-data", namespace = "http://entity.resource.rest.evoppi.sing-group.org")
...
public class AdministratorData extends UserData {
  ...
  public AdministratorData(String login, String email) {
    super(login, email, RoleType.ADMIN);
  }
  ...
  public String toString() {
    return "AdministratorData [getLogin()=" + getLogin() + ", getEmail()=" + getEmail() + "]";
  }
}
