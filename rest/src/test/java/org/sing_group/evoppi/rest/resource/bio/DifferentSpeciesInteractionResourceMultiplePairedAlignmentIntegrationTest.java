...
import org.sing_group.evoppi.rest.entity.bio.DifferentSpeciesInteractionsMultiplePairedAlignmentDataset;
...
public class DifferentSpeciesInteractionResourceMultiplePairedAlignmentIntegrationTest
extends InteractionResourceIntegrationTest {

  public DifferentSpeciesInteractionResourceMultiplePairedAlignmentIntegrationTest() {
    super(new DifferentSpeciesInteractionsMultiplePairedAlignmentDataset());
  }
  ...
  @Test
  @InSequence(10)
  @UsingDataSet("different-species-interactions-multiple-paired-alignment.xml")
  public void beforeDegree1() {}

  @Test
  @InSequence(12)
  @ShouldMatchDataSet("different-species-interactions-multiple-paired-alignment.xml")
