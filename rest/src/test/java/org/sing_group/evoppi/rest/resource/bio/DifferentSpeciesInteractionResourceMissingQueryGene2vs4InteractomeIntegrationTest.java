...
import org.sing_group.evoppi.rest.entity.bio.DifferentSpeciesInteractionResourceMissingQueryGene2vs4InteractomeDataset;
...
public class DifferentSpeciesInteractionResourceMissingQueryGene2vs4InteractomeIntegrationTest
extends InteractionResourceIntegrationTest {

  public DifferentSpeciesInteractionResourceMissingQueryGene2vs4InteractomeIntegrationTest() {
    super(new DifferentSpeciesInteractionResourceMissingQueryGene2vs4InteractomeDataset());
  }
  ...
  protected ResteasyWebTarget prepareQuery(ResteasyWebTarget webTarget) {
    return webTarget
      ...
      .queryParam("targetInteractome", 4);
  }
