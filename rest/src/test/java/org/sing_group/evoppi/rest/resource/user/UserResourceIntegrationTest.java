...
import static org.sing_group.evoppi.domain.entities.UsersDataset.invalidLogins;
...
public class UserResourceIntegrationTest {
  ...
  private static void testAuthorized(ResteasyWebTarget webTarget, User expectedUser) {
    ...
    try {
      ...
      assertThat(
        String.format("Access failed for user %s with password %s", expectedUser.getLogin(), passwordOf(expectedUser)),
        response, hasOkStatus()
      );
