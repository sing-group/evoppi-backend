...
import org.sing_group.evoppi.rest.entity.bio.DifferentSpeciesInteractionResourceMissingQueryGene2vs3InteractomeDataset;
...
public class DifferentSpeciesInteractionResourceMissingQueryGene2vs3InteractomeIntegrationTest
extends InteractionResourceIntegrationTest {

  public DifferentSpeciesInteractionResourceMissingQueryGene2vs3InteractomeIntegrationTest() {
    super(new DifferentSpeciesInteractionResourceMissingQueryGene2vs3InteractomeDataset());
  }
  ...
  protected ResteasyWebTarget prepareQuery(ResteasyWebTarget webTarget) {
    return webTarget
      .queryParam("gene", 100)
      .queryParam("referenceInteractome", 2)
      .queryParam("targetInteractome", 3);
  }
