...
import org.sing_group.evoppi.rest.entity.bio.DifferentSpeciesInteractionsDataset;
...
public class DifferentSpeciesInteractionResourceIntegrationTest
extends InteractionResourceIntegrationTest {

  public DifferentSpeciesInteractionResourceIntegrationTest() {
    super(new DifferentSpeciesInteractionsDataset());
  }
  ...
  @Test
  @InSequence(10)
  @UsingDataSet("different-species-interactions.xml")
  public void beforeDegree1() {}

  @Test
  @InSequence(12)
  @ShouldMatchDataSet("different-species-interactions.xml")
