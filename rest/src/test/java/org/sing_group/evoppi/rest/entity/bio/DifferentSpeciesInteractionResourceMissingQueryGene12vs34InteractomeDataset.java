  ...
  protected Stream<InteractionResultData> interactionsMaxDegree2() {
    return Stream.concat(
      ...
      Stream.of(
        ...
        new InteractionResultData(105, 107, degrees(1, 2, 3, -1, 4, -1)),
        new InteractionResultData(109, 110, degrees(1, 2, 2, -1, 3, -1, 4, -1)),
        new InteractionResultData(112, 113, degrees(1, 2, 2, 2, 3, -1, 4, -1))
      )
    );
  }
  ...
  protected Stream<InteractionResultData> interactionsMaxDegree3() {
    return Stream.concat(
      ...
      Stream.of(
        ...
        new InteractionResultData(102, 103, degrees(2, 2, 4, -1)),
        new InteractionResultData(105, 106, degrees(2, 2, 4, -1)),
        new InteractionResultData(105, 107, degrees(1, 2, 2, 3, 3, -1, 4, -1)),
        new InteractionResultData(109, 110, degrees(1, 2, 2, -1, 3, -1, 4, -1)),
        new InteractionResultData(112, 113, degrees(1, 2, 2, 2, 3, -1, 4, -1)),

        new InteractionResultData(103, 104, degrees(1, 3, 2, 3, 3, -1, 4, -1)),
        new InteractionResultData(107, 108, degrees(1, 3, 3, -1, 4, -1)),
        new InteractionResultData(110, 111, degrees(1, 3, 2, -1, 3, -1, 4, -1)),
        new InteractionResultData(113, 114, degrees(1, 3, 2, 3, 3, -1, 4, -1))
      )
    );
  }
}
