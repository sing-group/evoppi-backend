...
public class DifferentSpeciesInteractionResourceMissingQueryGene2vs4InteractomeDataset extends InteractionsDataset {
  ...
  protected Stream<InteractionResultData> interactionsMaxDegree2() {
    return Stream.concat(
      ...
      Stream.of(
        ...
        new InteractionResultData(112, "112", 113, "113", degrees(2, 2, 4, -1))
      )
    );
  }
  ...
  protected Stream<InteractionResultData> interactionsMaxDegree3() {
    return Stream.concat(
      ...
      Stream.of(
        new InteractionResultData(103, "103", 104, "104", degrees(2, 3, 4, -1)),
        new InteractionResultData(105, "105", 107, "107", degrees(2, 3, 4, -1)),
        new InteractionResultData(113, "113", 114, "114", degrees(2, 3, 4, -1))
      )
    );
  }
}
