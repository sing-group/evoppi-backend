...
public class DifferentSpeciesInteractionResourceMissingQueryGene1vs3InteractomeDataset extends InteractionsDataset {
  ...
  protected Stream<InteractionResultData> interactionsMaxDegree2() {
    return Stream.concat(
      ...
      Stream.of(
        ...
        new InteractionResultData(105, "105", 107, "107", degrees(1, 2, 3, -1)),
        new InteractionResultData(109, "109", 110, "110", degrees(1, 2, 3, -1)),
        new InteractionResultData(112, "112", 113, "113", degrees(1, 2, 3, -1))
      )
    );
  }
  ...
  protected Stream<InteractionResultData> interactionsMaxDegree3() {
    return Stream.concat(
      ...
      Stream.of(
        new InteractionResultData(103, "103", 104, "104", degrees(1, 3, 3, -1)),
        new InteractionResultData(107, "107", 108, "108", degrees(1, 3, 3, -1)),
        new InteractionResultData(110, "110", 111, "111", degrees(1, 3, 3, -1)),
        new InteractionResultData(113, "113", 114, "114", degrees(1, 3, 3, -1))
      )
    );
  }
}
