...
public interface DatabaseInteractomeCreationContext
...
> {
  Optional<EvoPpiInteractomeProcessingStatistics> getStatistics();

  Optional<GeneInteractions> getInteractions();
}
