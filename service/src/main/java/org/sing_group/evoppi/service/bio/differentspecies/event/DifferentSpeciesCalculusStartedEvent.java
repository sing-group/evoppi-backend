...
public class DifferentSpeciesCalculusStartedEvent
extends DifferentSpeciesCalculusEvent
implements Serializable, WorkStepEvent {
  private static final long serialVersionUID = 1L;

  public DifferentSpeciesCalculusStartedEvent(DifferentSpeciesCalculusEvent event) {
    super(event);
  }
  
  public DifferentSpeciesCalculusStartedEvent(
  ...
  public String getDescription() {
    return String.format("Calculating interactions for gene %d in interactome %d against interactome %d",
      this.getGeneId(),
