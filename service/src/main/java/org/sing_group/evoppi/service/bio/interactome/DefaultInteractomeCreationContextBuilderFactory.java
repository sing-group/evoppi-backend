...
public class DefaultInteractomeCreationContextBuilderFactory
  implements InteractomeCreationContextBuilderFactory {

  @Override
  public InteractomeCreationContextBuilder createBuilderFor(
    InteractomeCreationContext context
  ) {
    return new DefaultInteractomeCreationContextBuilder(context);
  }

  @Override
  public InteractomeCreationContextBuilder createBuilderFor(
    InteractomeCreationPipeline pipeline, InteractomeCreationConfiguration configuration,
