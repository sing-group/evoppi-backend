...
public class DefaultInteractomeCreationEvent
  implements InteractomeCreationEvent, WorkStepEvent, Serializable {
  private static final long serialVersionUID = 1L;

  private final InteractomeCreationContext context;
  ...
  public DefaultInteractomeCreationEvent(
    InteractomeCreationContext context, String description, double progress, ExecutionStatus status
  ) {
  ...
  public DefaultInteractomeCreationEvent(
    InteractomeCreationContext context, String description, double progress, String runningStepId,
  ...
  @Override
  public InteractomeCreationContext getContext() {
    return this.context;
  }
