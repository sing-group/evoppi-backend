...
public class DifferentSpeciesBlastAlignmentStartedEvent
extends DifferentSpeciesCalculusEvent
implements Serializable, WorkStepEvent {
  private static final long serialVersionUID = 1L;

  public DifferentSpeciesBlastAlignmentStartedEvent(DifferentSpeciesCalculusEvent event) {
    super(event);
  }
  
  public DifferentSpeciesBlastAlignmentStartedEvent(
  ...
  public String getDescription() {
    return "BLAST alignment started";
  }
