...
public interface InteractomeCreationContextBuilder {
  InteractomeCreationContext build();

  InteractomeCreationContextBuilder addStatistics(EvoPpiInteractomeProcessingStatistics statistics);

  InteractomeCreationContextBuilder addInteractions(GeneInteractions interactions);
}
