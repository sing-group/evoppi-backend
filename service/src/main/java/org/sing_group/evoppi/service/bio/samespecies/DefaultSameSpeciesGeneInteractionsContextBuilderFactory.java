...
public class DefaultSameSpeciesGeneInteractionsContextBuilderFactory
  implements SameSpeciesGeneInteractionsContextBuilderFactory {

  @Override
  public SameSpeciesGeneInteractionsContextBuilder createBuilderFor(
    SameSpeciesGeneInteractionsContext context
  ) {
    return new DefaultSameSpeciesGeneInteractionsContextBuilder(context);
  }

  @Override
  public SameSpeciesGeneInteractionsContextBuilder createBuilderFor(
    SameSpeciesGeneInteractionsPipeline pipeline, SameSpeciesGeneInteractionsConfiguration configuration,
    SameSpeciesGeneInteractionsEventManager eventManager
  ) {
    return new DefaultSameSpeciesGeneInteractionsContextBuilder(pipeline, configuration, eventManager);
  }
