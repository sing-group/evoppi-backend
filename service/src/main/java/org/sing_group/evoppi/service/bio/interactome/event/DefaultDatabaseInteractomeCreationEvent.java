...
public class DefaultDatabaseInteractomeCreationEvent
  implements DatabaseInteractomeCreationEvent, WorkStepEvent, Serializable {
  private static final long serialVersionUID = 1L;

  private final DatabaseInteractomeCreationContext context;
  ...
  public DefaultDatabaseInteractomeCreationEvent(
    DatabaseInteractomeCreationContext context, String description, double progress, ExecutionStatus status
  ) {
  ...
  public DefaultDatabaseInteractomeCreationEvent(
    DatabaseInteractomeCreationContext context, String description, double progress, String runningStepId,
  ...
  @Override
  public DatabaseInteractomeCreationContext getContext() {
    return this.context;
  }
