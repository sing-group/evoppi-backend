...
public class DifferentSpeciesReferenceInteractionsCalculusStartedEvent
extends DifferentSpeciesCalculusEvent
implements Serializable, WorkStepEvent {
  private static final long serialVersionUID = 1L;

  public DifferentSpeciesReferenceInteractionsCalculusStartedEvent(DifferentSpeciesCalculusEvent event) {
    super(event);
  }
  
  public DifferentSpeciesReferenceInteractionsCalculusStartedEvent(
  ...
  public String getDescription() {
    return String.format("Calculating interactions for gene %d in interactome %d with a maximum degree of %d",
      this.getGeneId(),
